...
var anime = (function () {
  ...
  var tweenId = 0;
  function convertKeyframesToTweens(keyframes, target, propertyName, animationType, index, total, targetPropertyTweens, animationOffsetTime, isOrphan) {
    var prevTween;
    var tweens = [];
    ...
    var _loop = function _loop(i, l) {
      ...
      var previousTargetTweenIndex = tweenIndex - 1;
      var previousTargetTween = targetPropertyTweens[previousTargetTweenIndex];
  ...
  function createAnimation(params, parentAnimation) {
    ...
    targets.forEach(function (targetTweens, target) {
      ...
      for (var j = 0, keysLength = propertyKeyframes.length; j < keysLength; j++) {
        ...
        if (is.num(type)) {
          var animationPropertyTweens = convertKeyframesToTweens(keyframes, target, property, type, i, targetsLength, targetPropertyTweens, animationSettings.timelineOffset, !parentAnimation);
