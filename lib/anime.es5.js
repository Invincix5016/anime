  ...
  function animate() {
    ...
    function setTweensProgress(insTime) {
      ...
      while (i < tweensLength) {
        ...
        var tween = tweens[i++];
        if (prevTween && prevTween.groupId == tween.groupId && insTime < prevTween.end || animation.reversePlayback && nextTween && nextTween.groupId == tween.groupId && insTime > nextTween.start) continue;
