  ...
  function createAnimation(params, parentAnimation) {
    ...
    targets.forEach(function (targetTweens, target) {
      ...
      for (var j = 0, keysLength = propertyKeyframes.length; j < keysLength; j++) {
        ...
        if (is.num(type)) {
          var animationPropertyTweens = convertKeyframesToTweens(keyframes, target, property, type, i, targetsLength, targetPropertyTweens, instanceSettings.timelineOffset);
