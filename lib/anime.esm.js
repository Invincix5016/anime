...
function convertKeyframesToTweens(animation, keyframes, target, targetPropertyTweens, propertyName, animationType, index) {
  let prevTween;
  const tweens = [];
...
function setAnimationProgress(animation, parentTime) {
