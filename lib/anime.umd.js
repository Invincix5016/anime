...
(function (global, factory) {
  ...
  function convertKeyframesToTweens(keyframes, target, propertyName, animationType, index, total, groupId, targetPropertyTweens, animationOffsetTime) {
    ...
    for (let i = 0, l = keyframes.length; i < l; i++) {
      ...
      tweens.push(tween);
      let sortedIndex = 0;
      for (sortedIndex = 0; sortedIndex < targetPropertyTweens.length && (targetPropertyTweens[sortedIndex].absoluteStart - tween.absoluteStart) < 0; sortedIndex++) {}    targetPropertyTweens.splice(sortedIndex, 0, tween);
